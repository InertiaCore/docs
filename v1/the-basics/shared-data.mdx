...
// ...or resolve per-request inside middleware, with Inertia.Lazy
// for values that should only be evaluated when needed.
app.Use(async (context, next) =>
{
    Inertia.Share("auth", Inertia.Lazy(() => context.User.Identity?.IsAuthenticated == true
