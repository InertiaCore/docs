...
If you scaffolded your app with [`create-inertiacore`](https://www.npmjs.com/package/create-inertiacore), SSR support is already wired up — enable it by setting `options.SsrEnabled = true` in `AddInertia(...)` and running the SSR build script:
