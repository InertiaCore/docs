...
// ASP.NET Core handles CSRF via anti-forgery tokens automatically.
// Add anti-forgery services in Program.cs:
builder.Services.AddAntiforgery();

// Use in the middleware pipeline:
app.UseAntiforgery();

// In Razor views, include the anti-forgery token:
// @Html.AntiForgeryToken()

// Protect controller actions with the [ValidateAntiForgeryToken] attribute:
// [HttpPost]
