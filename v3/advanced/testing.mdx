...
```csharp .NET icon="dotnet"
// With WebApplicationFactory you can override configuration per-test
// to disable SSR without touching appsettings files.
public class InertiaWebApplicationFactory
...
```csharp .NET icon="dotnet"
// Toggle SSR based on the hosting environment in Program.cs.
if (builder.Environment.IsEnvironment("Testing"))
{
    builder.Services.Configure<InertiaOptions>(options =>
    {
