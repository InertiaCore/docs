...
We strongly recommend using the CSRF protection middleware. Please see the [CSRF Protection](/v3/security/csrf-protection) documentation for more information.
...
We strongly recommend using the exception handling middleware. Please see the [Error Handling](/v3/advanced/error-handling) documentation for more information.
