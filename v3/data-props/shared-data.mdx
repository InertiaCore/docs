...
// Resolved once and remembered by the client across subsequent navigations.
...
// Register once-shared props per request from middleware.
app.Use(async (context, next) =>
{
    var db = context.RequestServices.GetRequiredService<AppDbContext>();

    Inertia.ShareOnce("countries", () => db.Countries.ToList());
