...
// In your controller, create a dedicated action
...
public class UsersController : Controller
{
    ...
    public IActionResult Index()
    {
        return Inertia.Render("Users/Index", new {
            Users = _context.Users.Select(u => new {
                u.Id,
                u.Name,
                u.Email,
                EditUrl = Url.Action("Edit", "Users", new { id = u.Id }),
            }).ToList(),
...
```csharp .NET icon="dotnet"
// In Program.cs, configure the URL resolver
