...
// In Program.cs, configure the asset version:
builder.Services.AddInertia(options =>
{
    options.VersionHash = Vite.GetManifestHash("wwwroot/build");
});
```
...
// In Program.cs, disable automatic versioning
// and share the version as a prop instead:
var assetVersion = Vite.GetManifestHash("wwwroot/build");
...
// Then in your middleware, share the version:
Inertia.Share("version", assetVersion);
```
