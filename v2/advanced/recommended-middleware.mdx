...
We strongly recommend using the CSRF protection middleware. Please see the [CSRF Protection](/v2/security/csrf-protection) documentation for more information.
...
We strongly recommend using the exception handling middleware. Please see the [Error Handling](/v2/advanced/error-handling) documentation for more information.
