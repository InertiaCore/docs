...
return Inertia.Render("Users/Index", new {
    Users = Inertia.Lazy(() => _context.Users.ToList()),
    Companies = Inertia.Lazy(() => _context.Companies.ToList()),
});
```
...
```csharp .NET icon="dotnet"
return Inertia.Render("Users/Index", new {
    Users = Inertia.Optional(() => _context.Users.ToList()),
});
```
...
```csharp .NET icon="dotnet"
return Inertia.Render("Users/Index", new {
    Users = Inertia.Always(() => _context.Users.ToList()),
});
```
...
```csharp .NET icon="dotnet"
return Inertia.Render("Users/Index", new {
    Users = Inertia.Once(() => _context.Users.ToList()),
});
```
